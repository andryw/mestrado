...
dados_filtrados = dados_filtrados[with(dados_filtrados, order(sign(dados_filtrados$pop_novid),sign(dados_filtrados$pop_conhec), dados_filtrados$pop_novid - dados_filtrados$pop_conhec)) ,]
