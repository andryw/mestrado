...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Titulo{Explorando as relações entre os aspectos de novidades musicais e as preferências pelos ouvintes}
\Autor{Andryw Marques Ramos}
\Data{05/09/2014}
\Area{Ciência da Computação}
\Pesquisa{Metodologias e técnicas da computação}
...
\input{4_dados2}
%\input{5_modelos2}
\input{6_preferencias}
\input{7_grupos}
\input{8_comparacao}
\input{9_conclusao}%\input{10_trabalhosfuturos}
